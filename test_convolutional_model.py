...
# -*- coding: utf-8 -*-
"""
Created on Mon Feb  1 12:11:25 2021
...
from convolutional_assets.decoder import Decoder
...
if __name__ == "__main__":
    ...
    if os.path.exists("./data/pad_vector.pkl"):
        ...
        pad_vec = np.random.randn(1,1,80)
    ...
    for (src_wavfile, tar_wavfile) in tqdm(zip(valid_src_folder, valid_tar_folder)):
        ...
        # pylab.subplot(223)
        # pylab.imshow(np.log10(attention.squeeze() + 1e-10))
        # pylab.plot(cords[0,:], cords[1,:], 'r-'), pylab.title('Attention with DTW path')
