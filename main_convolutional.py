...
#%% Generating samples from validation data auto-regressively
    ...
    output_dir = os.path.join("./outputs/CMU/convolutional/act_sampling", EMO_PAIR, 
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_name", type = str, help = "model name", default = "cmu-convolutional-model-act-sampling.pt")
